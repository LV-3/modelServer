...
class Sbert:
    def __init__(self):
        ...
        self.movie = pd.read_csv('app/resources/final_test_sbert_VODs_1127_1100.csv')
        ...
        self.index = faiss.read_index('app/resources/final_test_sbert_VODs_1127_1100.index')
    ...
    def save(self):
        faiss.write_index(self.index, 'app/resources/save_index.index')